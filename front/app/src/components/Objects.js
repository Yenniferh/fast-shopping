...
export const Input = (props) => {
  ...
  return (
    <input
      type={type}
      className='table-cell w-full border border-gray-300 text-gray-800 py-1 px-2 my-2 ml-2 rounded-md transition duration-500 ease-in-out focus:outline-none focus:border-fuchsia-500'
      id={name}
      name={name}
      value={value}
      onChange={onChange}
